...
global.anitav4 = process.env.BOT_NAME || "ZUKA AI";
global.ownername = process.env.OWNER_NAME || "Zuka";
global.packname = process.env.PACK_NAME || "ZUKA AI";
global.author = process.env.AUTHOR || "Zuka";
global.channelname = process.env.CHANNEL_NAME || "Zuka";
